...
//        CBUUID *cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Service Changed"]];
        ...
        //        CBUUID *cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlblockcomout04UUID"]];

        //        CBUUID *cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlblockcomin01UUID"]];
        //        CBUUID *cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlblockcomin02UUID"]];
        //        CBUUID *cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlblockcomin03UUID"]];
        ...
        cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlsystemValueUUID"]];
            [BLEUtility setNotificationForCharacteristic:self.d.p sCBUUID:sUUID cCBUUID:cUUID enable:YES];
        cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlblockcomin01UUID"]];
            [BLEUtility setNotificationForCharacteristic:self.d.p sCBUUID:sUUID cCBUUID:cUUID enable:YES];
...
/*
        ...
        [BLEUtility setNotificationForCharacteristic:self.d.p sCBUUID:sUUID cCBUUID:cUUID enable:YES];
        cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlblockcomout02UUID"]];
        [BLEUtility setNotificationForCharacteristic:self.d.p sCBUUID:sUUID cCBUUID:cUUID enable:YES];
        cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlblockcomout03UUID"]];
        [BLEUtility setNotificationForCharacteristic:self.d.p sCBUUID:sUUID cCBUUID:cUUID enable:YES];
        cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlblockcomout04UUID"]];
        [BLEUtility setNotificationForCharacteristic:self.d.p sCBUUID:sUUID cCBUUID:cUUID enable:YES];
        ...
        cUUID = [CBUUID UUIDWithString:[self.d.setupData valueForKey:@"Omron wlstreamcomValueUUID"]];
        [BLEUtility setNotificationForCharacteristic:self.d.p sCBUUID:sUUID cCBUUID:cUUID enable:YES];
*/
